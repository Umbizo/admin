...
def fetch_latest_trials(limit=10):
...
def send_emails(trials, sender_email, sender_password):
    ...
    for trial in trials:
        nct_id, title, contact_name, _, contact_email = trial
        if contact_email and contact_email != "N/A":
            subject = f"Data analysis support for clinical trials"
            body = f"Dear {contact_name},\n\nI recently read your proposal for your new clinical trial titled '{title}'. BODY OF EMAIL GOES HERE \n\nBest regards,\nHeather Robinson, Umbizo"
...
if __name__ == "__main__":
    ...
    sender_email = "heatherrobinson@umbizo.com"
    sender_password = "your_password"
    send_emails(latest_trials, sender_email, sender_password)
